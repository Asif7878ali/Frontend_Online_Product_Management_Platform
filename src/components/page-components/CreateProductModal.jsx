...
import { MediumModal } from "../ui/Modals";
...
import { isNumbers, isValidFileType } from "../../lib/filterFunctions";
...
const CreateProductModal = ({ openModal, onCloseModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { errors, isvalid } = createProductValidation(form);
    setErrors(errors);
    ...
    try {
      ...
      const response = await axios.post(
        `${configCenter.urls.base}${endPoint.create_product}`,
        formData,
        {
          headers: {
