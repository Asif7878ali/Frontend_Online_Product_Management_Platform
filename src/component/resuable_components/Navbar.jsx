    ...
    <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-lg border-b border-gray-100 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Link
            to="/auth"
            className="flex items-center gap-2 bg-rose-600 text-white hover:bg-rose-700 px-5 py-2 rounded-full font-medium transition-all shadow-md shadow-indigo-200"
          >
      ...
      >
        <div className="px-4 py-6 space-y-4 flex flex-col">
          ...
          <Link
            to="/auth"
            className="w-full text-center text-gray-700 font-medium py-3 border border-gray-200 rounded-lg hover:bg-gray-50 block"
          >
            Log in
          </Link>
          <Link
            to="/auth"
            className="w-full flex items-center justify-center gap-2 bg-rose-600 text-white hover:bg-rose-700 py-3 rounded-lg font-medium"
          >
